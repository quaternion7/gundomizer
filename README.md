...
**Version 0.1.3 is a local prototype.** The first playtest confirmed both spawning buttons and tooltips work. The updated visuals, optional selection-only mode, and nearby polling still need a VR playtest. Bullet-property filters and a coordinated loadout/kit system are outside this prototype.
...
Local package: `artifacts/quaternion-Gundomizer-0.1.3.zip`.
